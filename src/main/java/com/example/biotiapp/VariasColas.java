...
public class VariasColas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_varias_colas);

        init();

        tname = (TextView)findViewById(R.id.textViewName13);
    ...
    public void init(){
        ...
        colas.add("Baetidae");
        colas.add("Leptohyphidea");
        colas.add("Leptophlebiidae");
        colas.add("Perlidae");

        for (int i = 0; i < colas.size(); i++){
            elements.add(new ListElement(colas.get(i),this));
        }
